  ...
  describe('partial-type', () => {
    ...
    describe('more-classes', () => {
      ...
      test('instance props', () => {
        ...
        expect(reflect(ClassY).getProperty('c').isOptional).toBe(true)
        expect(reflect(ClassY).getProperty('d').isOptional).toBe(true)
        expect(reflect(ClassY).getProperty('e').isOptional).toBe(true)
        expect(reflect(ClassY).getProperty('f').isOptional).toBe(true)
        expect(reflect(ClassY).getProperty('g').isOptional).toBe(true)
        expect(reflect(ClassY).getProperty('h').isOptional).toBe(true)
        expect(reflect(ClassY).getProperty('i').isOptional).toBe(false)
        expect(reflect(ClassY).getProperty('ii').isOptional).toBe(false)
      })
      ...
      test('instance methods', () => {
        ...
        expect(reflect(ClassY).getMethod('j').isOptional).toBe(true)
        expect(reflect(ClassY).getMethod('k').isOptional).toBe(true)
        expect(reflect(ClassY).getMethod('l').isOptional).toBe(true)
        expect(reflect(ClassY).getMethod('m').isOptional).toBe(true)
        expect(reflect(ClassY).getMethod('n').isOptional).toBe(false)
      })
